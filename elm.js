...
Elm.Main.make = function (_elm) {
   ...
   var collide = F2(function (agent1,
   agent2) {
      return function () {
         switch (agent1.ctor)
         {case "Alive":
            return function () {
                 switch (agent2.ctor)
                 {case "Alive":
                    return agent1._0.checkCollision(agent2) || agent2._0.checkCollision(agent1) ? function () {
                         var newA2 = agent2._0.collide(agent1._0.health);
                         var newA1 = agent1._0.collide(agent2._0.health);
                         return {ctor: "_Tuple2"
                                ,_0: newA1
                                ,_1: newA2};
                      }() : {ctor: "_Tuple2"
            ...
            return {ctor: "_Tuple2"
                   ...
                   ,_1: agent2};}
         _U.badCase($moduleName,
         "between lines 885 and 898");
      }();
   });
   var progress = function (state) {
      return $List.isEmpty(state.events) ? state : function () {
         var $ = $List.head(state.events),
         time = $._0,
         next = $._1;
         return _U.cmp(state.age,
         time) > 0 ? progress(_U.replace([["badAgents"
                                          ,A2($List._op["::"],
                                          next,
                                          state.badAgents)]
                                         ,["events"
                                          ,$List.tail(state.events)]],
         state)) : state;
      }();
   };
   var actionOnPress = F2(function (act,
   state) {
      return state.playerFire ? act(state) : state;
   });
   var updateOnPress = F3(function (update,
   agent,
   state) {
      return state.playerFire ? A2(update,
      agent,
      state) : agent;
   });
   var triangleShip = $Graphics$Collage.filled($Color.yellow)($Graphics$Collage.polygon(_L.fromArray([{ctor: "_Tuple2"
                                                                                                      ,_0: -20
                                                                                                      ,_1: -10}
                                                                                                     ,{ctor: "_Tuple2"
                                                                                                      ,_0: 0
                                                                                                     ...
                                                                                                     ,{ctor: "_Tuple2"
                                                                                                      ,_0: 20
                                                                                                      ,_1: -10}])));
   var playerShip = $Graphics$Collage.filled($Color.blue)($Graphics$Collage.polygon(_L.fromArray([{ctor: "_Tuple2"
                                                                                                  ,_0: -20.0
                                                                                                  ,_1: -20.0}
                                                                                                 ,{ctor: "_Tuple2"
                                                                                                  ,_0: -15.0
                                                                                                 ...
                                                                                                 ,{ctor: "_Tuple2"
                                                                                                  ,_0: 20.0
                                                                                                  ,_1: -20.0}])));
   var action = F2(function (agent,
   state) {
      return function () {
         switch (agent.ctor)
         {case "Alive":
            return agent._0.action(state);
            case "Dead": return state;}
         _U.badCase($moduleName,
         "between lines 317 and 319");
      }();
   });
   var doActions = function (state) {
      return function () {
         var _v6 = state.player;
         switch (_v6.ctor)
         {case "Alive":
            return function () {
                 var s1 = A3($List.foldl,
                 action,
                 state,
                 state.goodBullets);
                 var s2 = A3($List.foldl,
                 action,
                 s1,
                 state.badBullets);
                 var s3 = A3($List.foldl,
                 action,
                 s2,
                 state.badAgents);
                 return A2(action,
            ...
            case "Dead": return state;}
         _U.badCase($moduleName,
         "between lines 945 and 951");
      }();
   };
   var position = function (agent) {
      return function () {
         switch (agent.ctor)
         {case "Alive":
            return agent._0.position;
            case "Dead":
            return {ctor: "_Tuple2"
                   ,_0: 0.0
                   ,_1: -10000};}
   ...
   var nullAction = function (state) {
      return state;
   };
   var nullDraw = A2($Graphics$Collage.filled,
   $Color.black,
   $Graphics$Collage.circle(0));
   var draw = function (agent) {
      return function () {
         switch (agent.ctor)
         {case "Alive":
            return agent._0.draw;
            case "Dead": return nullDraw;}
         _U.badCase($moduleName,
         "between lines 312 and 314");
      }();
   };
   var applyCollision = F4(function (health,
   damage,
   survives,
   dies) {
      return function () {
         var newHealth = health - damage;
         return _U.cmp(newHealth,
         0) < 1 ? dies : survives(newHealth);
      }();
   });
   var vectorAngle = function (_v12) {
      return function () {
         switch (_v12.ctor)
         {case "_Tuple2":
            return A2($Basics.atan2,
              ...
              _v12._0);}
         _U.badCase($moduleName,
         "on line 272, column 3 to 12");
      }();
   };
   var rotateToVector = F2(function (vector,
   form) {
      return A2($Graphics$Collage.rotate,
      vectorAngle(vector),
      form);
   });
   var vectorScale = F2(function (scalar,
   _v16) {
      return function () {
         switch (_v16.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: scalar * _v16._1};}
         _U.badCase($moduleName,
         "on line 268, column 4 to 26");
      }();
   });
   var vectorMag = function (_v20) {
      return function () {
         switch (_v20.ctor)
         {case "_Tuple2":
         ...
         _U.badCase($moduleName,
         "on line 264, column 3 to 18");
      }();
   };
   var vectorDist = F2(function (_v24,
   _v25) {
      return function () {
         switch (_v25.ctor)
         {case "_Tuple2":
            return function () {
                 switch (_v24.ctor)
                 {case "_Tuple2":
                    return $Basics.sqrt(Math.pow(_v24._0 - _v25._0,
                      2) + Math.pow(_v24._1 - _v25._1,
                      2));}
                 _U.badCase($moduleName,
                 "on line 260, column 3 to 34");
              }();}
         _U.badCase($moduleName,
         "on line 260, column 3 to 34");
      }();
   });
   var within = F3(function (pos,
   dist,
   agent) {
      return function () {
         switch (agent.ctor)
         {case "Alive":
            return _U.cmp(A2(vectorDist,
              pos,
              agent._0.position),
              dist) < 0;
   ...
   var closestEnemyFold = F3(function (pos,
   nextAgent,
   _v34) {
      return function () {
         switch (_v34.ctor)
         {case "_Tuple2":
            return function () {
                 var nextDist = A2(vectorDist,
                 pos,
                 position(nextAgent));
                 return _U.cmp(nextDist,
                 _v34._0) < 0 ? {ctor: "_Tuple2"
                                ,_0: nextDist
                                ,_1: nextAgent} : {ctor: "_Tuple2"
                                                  ,_0: _v34._0
                                                  ,_1: _v34._1};
              }();}
         _U.badCase($moduleName,
         "between lines 417 and 422");
      }();
   });
   var closestEnemyPosition = F2(function (vec,
   state) {
      return $List.isEmpty(state.badAgents) ? {ctor: "_Tuple2"
                                              ,_0: 0
                                              ,_1: 10000} : function () {
         var rest = $List.tail(state.badAgents);
         var first = $List.head(state.badAgents);
         var firstDist = A2(vectorDist,
         position(first),
         vec);
         var $ = A3($List.foldl,
         closestEnemyFold(vec),
         {ctor: "_Tuple2"
         ,_0: firstDist
         ,_1: first},
         rest),
   ...
   v2) {
      return function () {
         var diff = vectorAngle(v1) - vectorAngle(v2);
         return _U.cmp(diff,
         2 * $Basics.pi) > 0 ? diff - 2 * $Basics.pi : _U.cmp(diff,
         0) < 0 ? diff + 2 * $Basics.pi : diff;
      }();
   });
   var vectorPolar = F2(function (mag,
   angle) {
      return {ctor: "_Tuple2"
             ,_0: mag * $Basics.cos(angle)
             ,_1: mag * $Basics.sin(angle)};
   });
   var shootBulletFanHelper = F6(function (makeBullet,
   speed,
   angle,
   interval,
   n,
   agents) {
      ...
      n - 1,
      A2($List._op["::"],
      makeBullet(A2(vectorPolar,
      speed,
      angle)),
      agents)) : agents;
   });
   var shootBulletFan = F7(function (makeBullet,
   position,
   speed,
   initAngle,
   interval,
   ...
   state) {
      return function () {
         var result = A6(shootBulletFanHelper,
         makeBullet(position),
         speed,
         initAngle,
         interval,
         num,
         state.badBullets);
         return _U.replace([["badBullets"
                            ,result]],
         state);
      }();
   });
   var shootGoodBulletFan = F7(function (makeBullet,
   position,
   speed,
   initAngle,
   interval,
   ...
   state) {
      return function () {
         ...
         num,
         state.goodBullets);
         return _U.replace([["goodBullets"
                            ,result]],
         state);
      }();
   });
   var basicGun = F3(function (makeBullet,
   coolDown,
   speed) {
      return {_: {}
             ,action: F3(function (pos,
             angle,
             state) {
                return _U.replace([["badBullets"
                                   ,A2($List._op["::"],
   ...
   var basicSpawn = F3(function (makeAgent,
   coolDown,
   speed) {
      return {_: {}
             ,action: F3(function (pos,
   ...
   var vectorDiff = F2(function (_v38,
   _v39) {
      return function () {
         switch (_v39.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v38._1 - _v39._1};}
                 _U.badCase($moduleName,
                 "on line 237, column 4 to 15");
              }();}
         _U.badCase($moduleName,
         "on line 237, column 4 to 15");
      }();
   });
   var vectorAdd = F2(function (_v46,
   _v47) {
      return function () {
         switch (_v47.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v46._1 + _v47._1};}
                 _U.badCase($moduleName,
                 "on line 233, column 4 to 20");
              }();}
         _U.badCase($moduleName,
         "on line 233, column 4 to 20");
      }();
   });
   var vectorAddPolar = F3(function (vect,
   mag,
   angle) {
      return A2(vectorAdd,
      vect,
      A2(vectorPolar,mag,angle));
   });
   var seeker = F4(function (makeAgent,
   pos,
   speed,
   state) {
      return function () {
         var playerAngle = vectorAngle(A2(vectorDiff,
         position(state.player),
         pos));
         var velocity = A2(vectorPolar,
         speed,
         playerAngle);
         var displacement = A2(vectorScale,
         state.deltas,
         velocity);
         var nextPosition = A2(vectorAdd,
         pos,
         displacement);
         return A2(makeAgent,
         nextPosition,
   ...
   var goodSeeker = F4(function (makeAgent,
   pos,
   speed,
   state) {
      return function () {
         var closestEnemy = A2(closestEnemyPosition,
         pos,
         state);
         var angle = vectorAngle(A2(vectorDiff,
         closestEnemy,
         pos));
         var vel = A2(vectorPolar,
         speed,
         angle);
         var disp = A2(vectorScale,
         state.deltas,
         vel);
         var nextPos = A2(vectorAdd,
         pos,
         disp);
         return A2(makeAgent,
         nextPos,
   ...
   var moveStrait = F4(function (makeAgent,
   position,
   velocity,
   time) {
      return function () {
   ...
   var moveTurning = F5(function (rot,
   makeAgent,
   pos,
   vel,
   deltas) {
      return function () {
         var oldAngle = vectorAngle(vel);
         var newAngle = oldAngle + deltas * rot;
         var newVel = A2(vectorPolar,
         vectorMag(vel),
         newAngle);
         var disp = A2(vectorScale,
         deltas,
   ...
   var orbiter = F5(function (goalRadius,
   makeAgent,
   deltas,
   pos,
   vel) {
      return function () {
         var strait = A4(moveStrait,
         makeAgent,
         pos,
         vel,
         deltas);
         var speed = vectorMag(vel) * deltas;
         var radius = vectorMag(pos);
         var radvel = speed * radius;
         var ang = A2(angle,pos,vel);
         var cenvec = A2(vectorDiff,
         pos,
         {ctor: "_Tuple2",_0: 0,_1: 0});
         return _U.cmp(radius,
         goalRadius) < 0 ? strait : _U.cmp(ang,
         $Basics.pi / 2) < 0 ? A5(moveTurning,
         radvel,
         makeAgent,
         pos,
         vel,
         deltas) : _U.cmp(ang,
         3 * $Basics.pi / 2) > 0 ? A5(moveTurning,
         radvel,
         makeAgent,
         pos,
         vel,
   ...
   var PlayerWeapons = F5(function (a,
   b,
   c,
   d,
   e) {
   ...
   var overHeat = function (weapon) {
      return _U.replace([["wait"
                         ,weapon.coolDown]],
      weapon);
   };
   var fireIfReady = F4(function (weapon,
   pos,
   ang,
   state) {
      return _U.cmp(weapon.wait,
      0) < 1 ? A3(weapon.action,
      pos,
      ang,
      state) : state;
   });
   var firePlayerWeapons = F4(function (playerWeapons,
   position,
   angle,
   state) {
      return A3(fireIfReady,
      playerWeapons.mines,
      position,
      angle)(A3(fireIfReady,
      playerWeapons.lasers,
      position,
      angle)(A3(fireIfReady,
      playerWeapons.missiles,
      position,
      angle)(A3(fireIfReady,
      playerWeapons.rockets,
      position,
      angle)(A4(fireIfReady,
      playerWeapons.bullets,
      position,
      angle,
      state)))));
   });
   var coolDown = F2(function (deltas,
   weapon) {
      return _U.cmp(weapon.wait,
      0) > 0 ? _U.replace([["wait"
                           ,weapon.wait - deltas]],
      weapon) : _U.replace([["wait"
                            ,0]],
      weapon);
   });
   var updateWeapon = F2(function (time,
   weapon) {
      return _U.cmp(weapon.wait,
      0) < 1 ? overHeat(weapon) : A2(coolDown,
      time,
      weapon);
   });
   var updatePlayerWeapons = F2(function (deltas,
   playerWeapons) {
   ...
   var PlayerWeapon = F3(function (a,
   b,
   c) {
      return {_: {}
             ,action: c
   ...
   var Dead = {ctor: "Dead"};
   var update = F2(function (state,
   agent) {
      return function () {
         switch (agent.ctor)
         {case "Alive":
            return agent._0.update(state);
            case "Dead": return Dead;}
         _U.badCase($moduleName,
         "between lines 307 and 309");
      }();
   });
   var doUpdates = function (state) {
      return _U.replace([["goodBullets"
                         ,A2($List.map,
                         update(state),
                         state.goodBullets)]
   ...
   var collisionHelper = F2(function (_v56,
   agents) {
      return function () {
         switch (_v56.ctor)
         {case "_Tuple2":
            return $List.isEmpty(agents) ? {ctor: "_Tuple2"
                                           ,_0: _v56._0
                                           ,_1: _v56._1} : function () {
                 var rest = $List.tail(agents);
                 var next = $List.head(agents);
                 return function () {
                    switch (_v56._0.ctor)
                    {case "Alive":
                       return function () {
                       ...
                       return {ctor: "_Tuple2"
                              ...
                              agents)};}
                    _U.badCase($moduleName,
                    "between lines 910 and 919");
                 }();
              }();}
         _U.badCase($moduleName,
         "between lines 903 and 919");
      }();
   });
   var collisionFold = F2(function (goodBullet,
   state) {
      return function () {
         var $ = A2(collisionHelper,
         {ctor: "_Tuple2"
         ,_0: goodBullet
         ,_1: _L.fromArray([])},
         state.badAgents),
         ...
         return function () {
            ...
            {case "Alive":
               ...
               return _U.replace([["badAgents"
                 ...
                 state);}
            _U.badCase($moduleName,
            "between lines 926 and 932");
         }();
      }();
   });
   var doCollisions = function (state) {
      return function () {
         var $ = A2(collisionHelper,
         {ctor: "_Tuple2"
         ,_0: state.player
         ...
         newPlayer = $._0,
         badBullets = $._1;
         var newState = _U.replace([["player"
                                    ,newPlayer]
                                   ,["badAgents",badAgents]
                                   ,["badBullets",badBullets]],
         state);
         return A3($List.foldl,
         collisionFold,
         _U.replace([["goodBullets"
                     ,_L.fromArray([])]],
         newState),
         newState.goodBullets);
      }();
   };
   var Alive = function (a) {
      return {ctor: "Alive",_0: a};
   };
   var setDraw = F2(function (form,
   agent) {
      return function () {
         switch (agent.ctor)
         {case "Alive":
            return Alive(_U.replace([["draw"
                                     ,form]],
              agent._0));
            case "Dead": return Dead;}
         _U.badCase($moduleName,
   ...
   var addAction = F2(function (newAction,
   agent) {
      return function () {
         switch (agent.ctor)
         {case "Alive":
            return Alive(_U.replace([["action"
                                     ,function ($) {
                                        return newAction(agent._0.action($));
                                     }]],
              agent._0));
            case "Dead": return Dead;}
         _U.badCase($moduleName,
   ...
   var addUpdate = F2(function (newUpdate,
   agent) {
      return function () {
         switch (agent.ctor)
         {case "Alive":
            return Alive(_U.replace([["update"
                                     ,function (state) {
                                        return A2(newUpdate,
                                        agent._0.update(state),
                                        state);
                                     }]],
              agent._0));
            case "Dead": return Dead;}
         _U.badCase($moduleName,
         "between lines 329 and 333");
      }();
   });
   var goodLaser = F2(function (alive,
   source) {
      return function () {
         var nextSource = function (state) {
            return A2(vectorAdd,
            A2(vectorScale,
            state.deltas,
            state.playerMove),
         ...
         var nextAlive = function (state) {
            return alive - state.deltas;
         };
         var update = function (state) {
            return _U.cmp(nextAlive(state),
            0) > 0 ? A2(goodLaser,
            nextAlive(state),
            nextSource(state)) : Dead;
         };
         return Alive({_: {}
                      ,action: function (state) {
                         return state;
                      }
                      ,checkCollision: function (agent) {
                         return function () {
                            var $ = source,
                            sx = $._0,
                            sy = $._1;
                            ...
                            y = $._1;
                            return _U.cmp(y,
                            sy) > 0 && _U.cmp($Basics.abs(x - sx),
                            30) < 1;
                         }();
                      }
                      ,collide: function (dam) {
                         return A2(goodLaser,
                         alive,
                         source);
                      }
                      ,draw: A2($Graphics$Collage.move,
                      source,
   ...
   ang) {
      return Alive({_: {}
                   ...
                   ,draw: A2($Graphics$Collage.rotate,
   ...
   var changeUpdate = F2(function (agent,
   update) {
      return function () {
         switch (agent.ctor)
         {case "Alive":
            ...
            case "Dead": return Dead;}
         _U.badCase($moduleName,
         "between lines 708 and 710");
      }();
   });
   var dieAfter = function (agent) {
      return A2(changeUpdate,
      agent,
      F2(function (a,s) {
         return Dead;
      }));
   };
   var explosion = F3(function (pos,
   damage,
   rad) {
      return Alive({_: {}
                   ,action: function (state) {
                   ...
                   ,position: pos
                   ,update: function (state) {
                      return dieAfter(A3(explosion,
                      pos,
                      damage,
                      rad));
                   }});
   });
   var stabber = F3(function (health,
   pos,
   ang) {
      return Alive({_: {}
                   ,action: function (state) {
                   ...
                   20)
                   ,collide: function (dam) {
                      return A4(applyCollision,
                      health,
                      dam,
                      function (h) {
                         return A3(stabber,h,pos,ang);
                      },
                      A3(explosion,pos,0,50));
                   }
                   ,draw: A2($Graphics$Collage.rotate,
                   ang - $Basics.degrees(90),
                   A2($Graphics$Collage.move,
   ...
   var chaser = F4(function (weapon,
   health,
   pos,
   angle) {
      return function () {
         var dist = function (state) {
            return A2(vectorDist,
            pos,
            position(state.player));
         };
         return Alive({_: {}
                      ,action: function (state) {
                         return A4(fireIfReady,
                         weapon,
                         pos,
                         angle,
                         state);
                      ...
                      ,update: function (state) {
                         ...
                         health),
                         pos,
                         0.4 * (dist(state) - 100) / 100,
                         state);
                      }});
      }();
   });
   var carrier = F5(function (radius,
   spawn,
   health,
   pos,
   vel) {
      return Alive({_: {}
                   ...
                   ,collide: function (dam) {
                      ...
                      A3(explosion,pos,0,150));
                   }
                   ,draw: $Graphics$Collage.rotate(vectorAngle(vel))($Graphics$Collage.move(pos)($Graphics$Collage.filled($Color.grey)($Graphics$Collage.polygon(_L.fromArray([{ctor: "_Tuple2"
                                                                                                                                                                               ,_0: -100
                                                                                                                                                                               ,_1: 75}
                                                                                                                                                                              ,{ctor: "_Tuple2"
                                                                                                                                                                               ,_0: -75
   ...
   var stabberCarrier = F3(function (rad,
   pos,
   vel) {
      return function () {
         var makeStabber = F2(function (p,
         v) {
            return A3(stabber,
            2,
            p,
   ...
   vel) {
      return Alive({_: {}
                   ...
                   ,draw: $Graphics$Collage.rotate(vectorAngle(vel) - $Basics.degrees(90))($Graphics$Collage.move(pos)($Graphics$Collage.filled($Color.yellow)($Graphics$Collage.polygon(_L.fromArray([{ctor: "_Tuple2"
                                                                                                                                                                                                       ,_0: -15
                                                                                                                                                                                                       ,_1: -20}
                                                                                                                                                                                                      ,{ctor: "_Tuple2"
                                                                                                                                                                                                       ,_0: -15
   ...
   var scrollSpeed = 0.1;
   var doBackground = function (state) {
      return _U.replace([["background"
                         ,A2($Graphics$Collage.moveY,
                         (0 - scrollSpeed) * state.deltas,
                         state.background)]],
      state);
   };
   var screenHeight = 800;
   var aboveScreen = $Basics.toFloat(screenHeight) / 2 + 200;
   var belowScreen = 0 - aboveScreen;
   var generatePoints = function () {
      var pointgen = A2($Random.list,
      1500,
      A2($Random.pair,
      A2($Random.$float,-600,600),
      A2($Random.$float,
      0 - screenHeight,
      20000 - screenHeight)));
   ...
   var killIfOffScreen = F3(function (_v74,
   agent,
   state) {
      return function () {
         switch (_v74.ctor)
         {case "_Tuple2":
            return function () {
                 switch (agent.ctor)
                 {case "Alive":
                    return _U.cmp($Basics.abs(_v74._0) - 300,
                      $Basics.toFloat(screenWidth) / 2) > 0 || _U.cmp($Basics.abs(_v74._1) - 300,
                      $Basics.toFloat(screenHeight) / 2) > 0 ? Dead : Alive(agent._0);
                    case "Dead": return Dead;}
                 _U.badCase($moduleName,
                 "between lines 351 and 358");
              }();}
         _U.badCase($moduleName,
         "between lines 351 and 358");
      }();
   });
   var basicBullet = F3(function (form,
   pos,
   velocity) {
      return function () {
         var update = function (state) {
         ...
         var newForm = A2($Graphics$Collage.rotate,
         vectorAngle(velocity),
         A2($Graphics$Collage.move,
         pos,
         form));
         return addUpdate(killIfOffScreen(pos))(Alive({_: {}
                                                      ,action: function (state) {
                                                         return state;
                                                      }
                                                      ,checkCollision: A2(within,
   ...
   var goodBullet = F2(function (pos,
   vel) {
      return A3(basicBullet,
      A2($Graphics$Collage.filled,
      $Color.green,
   ...
   var goodBulletExplosion = function (pos) {
      return Alive({_: {}
                   ,action: function (state) {
                      return A7(shootGoodBulletFan,
                      goodBullet,
                      pos,
                      0.5,
                      0,
                   ...
                   ,collide: function (dam) {
                      return goodBulletExplosion(pos);
                   }
                   ,draw: nullDraw
                   ,health: 0
                   ,position: pos
   ...
   vel) {
      return Alive({_: {}
                   ...
                   ,draw: $Graphics$Collage.move(pos)($Graphics$Collage.filled($Color.green)($Graphics$Collage.circle(10)))
                   ,health: 0
                   ,position: pos
                   ,update: function (state) {
                      return _U.cmp(time,
                      0) < 1 ? A4(moveStrait,
                      mine(time - state.deltas),
                      pos,
                      {ctor: "_Tuple2"
                      ,_0: 0
                      ,_1: 0 - scrollSpeed},
                      state.deltas) : A4(moveStrait,
                      mine(time - state.deltas),
                      pos,
                      vel,
                      state.deltas);
   ...
   var playerWeapons = {_: {}
                       ...
                       ,rockets: {_: {}
                                 ...
                                 ,coolDown: 1000
                                 ,wait: 0}};
   var coolDownPlayerWeapons = F2(function (deltas,
   weapons) {
      return _U.replace([["bullets"
                         ,A2(coolDown,
                         deltas,
   ...
   var bulletChaser = function (pos) {
      return A4(chaser,
      A3(basicGun,badBullet,250,0.6),
      6,
      pos,
      0);
   };
   var bulletChaserCarrier = F3(function (rad,
   pos,
   vel) {
      return function () {
         var makeChaser = F2(function (p,
         v) {
            return bulletChaser(p);
         });
         return A5(carrier,
         rad,
         A3(basicSpawn,
   ...
   var bulletExplosion = function (pos) {
      return Alive({_: {}
                   ,action: function (state) {
                      return A7(shootBulletFan,
                      badBullet,
                      pos,
                      0.5,
                      0,
   ...
   var exploder = F5(function (rot,
   time,
   health,
   position,
   velocity) {
      return function () {
         var makeAgent = F3(function (state,
         pos,
         vel) {
            return function () {
               var newTime = time - state.deltas;
               return _U.cmp(newTime,
               0) < 1 ? bulletExplosion(position) : A5(exploder,
               rot,
               newTime,
               health,
               pos,
         ...
         return Alive({_: {}
                      ...
                      ,draw: $Graphics$Collage.move(position)(A2($Graphics$Collage.filled,
                      $Color.red,
                      $Graphics$Collage.circle(20)))
                      ,health: health
                      ,position: position
                      ,update: function (state) {
                         return A5(moveTurning,
                         rot,
                         makeAgent(state),
                         position,
                         velocity,
   ...
   var sprayerGun = {_: {}
                    ...
                    ,coolDown: 700
                    ,wait: 0};
   var lineFlyer = F5(function (form,
   gun,
   health,
   position,
   velocity) {
      return function () {
         var collide = function (dam) {
            return A4(applyCollision,
            health,
            dam,
            function ($new) {
            ...
            A3(explosion,position,0,30));
         };
         var makeFlyer = F3(function (state,
         pos,
         vel) {
            return A5(lineFlyer,
            form,
         ...
         return addUpdate(killIfOffScreen(position))(Alive({_: {}
                                                           ,action: function (state) {
                                                              return A4(fireIfReady,
                                                              gun,
                                                              position,
                                                           ...
                                                           ,draw: A2($Graphics$Collage.rotate,
                                                           vectorAngle(velocity) - $Basics.degrees(90),
                                                           A2($Graphics$Collage.move,
                                                           position,
                                                           triangleShip))
                                                           ,health: health
   ...
   var shooter = F2(function (pos,
   vel) {
      return function () {
         var shape = $Graphics$Collage.filled($Color.orange)($Graphics$Collage.polygon(_L.fromArray([{ctor: "_Tuple2"
                                                                                                     ,_0: -15
                                                                                                     ,_1: -30}
                                                                                                    ,{ctor: "_Tuple2"
                                                                                                     ,_0: 10
         ...
         return A5(lineFlyer,
         shape,
         A3(basicGun,badBullet,1000,0.4),
         2,
         pos,
         vel);
      }();
   });
   var sprayer = F2(function (pos,
   vel) {
      return A5(lineFlyer,
      triangleShip,
      sprayerGun,
   ...
   var player = F3(function (weapons,
   health,
   position) {
      return function () {
         var nextWeapon = function (state) {
            return state.playerFire ? A2(updatePlayerWeapons,
            state.deltas,
            weapons) : A2(coolDownPlayerWeapons,
            state.deltas,
            weapons);
         };
         var right = $Basics.toFloat(screenWidth) / 2;
         var left = 0 - right;
         var top = $Basics.toFloat(screenHeight) / 2;
         var bot = 0 - top;
         var nextPosition = function (state) {
            return function () {
               var $ = A2(vectorAdd,
               A2(vectorScale,
               state.deltas,
         ...
         return Alive({_: {}
                      ,action: function (state) {
                         return A2(actionOnPress,
                         A3(firePlayerWeapons,
                         weapons,
                         position,
                         $Basics.degrees(90)),
                         state);
   ...
   var drawState = function (state) {
      return function () {
         ...
         draw,
         state.goodBullets);
         var drawpend = F2(function (e,
         l) {
            return A2($List._op["::"],
            draw(e),
            l);
         });
         var f2 = A3($List.foldl,
         drawpend,
         f1,
         state.badAgents);
         var f3 = A3($List.foldl,
         drawpend,
         f2,
         state.badBullets);
         var f4 = A2($List._op["::"],
   ...
   var rightScreen = $Basics.toFloat(screenWidth) / 2 + 200;
   var leftScreen = 0 - rightScreen;
   var events = _L.fromArray([{ctor: "_Tuple2"
                              ,_0: 500
                              ,_1: A2(shooter,
                              {ctor: "_Tuple2"
                              ,_0: -400
   ...
   var background = function () {
      var star = A2($Graphics$Collage.filled,
      $Color.white,
      $Graphics$Collage.circle(1));
      var points = generatePoints;
      var stars = A2($List.map,
      A2($Basics.flip,
      $Graphics$Collage.move,
      star),
      points);
      var space = A2($Graphics$Collage.moveY,
      10000 - screenHeight,
      A2($Graphics$Collage.filled,
      $Color.black,
   ...
   var playerSpeed = 0.5;
   var setInput = F2(function (state,
   _v80) {
      return function () {
         switch (_v80.ctor)
         {case "_Tuple3":
            return _U.replace([["deltas"
                               ,_v80._0]
                              ,["playerMove"
                               ,A2(vectorScale,
                               playerSpeed,
                               {ctor: "_Tuple2"
                               ,_0: $Basics.toFloat(_v80._1.x)
                               ,_1: $Basics.toFloat(_v80._1.y)})]
                              ,["playerFire",_v80._2]
                              ,["age",state.age + _v80._0]],
              state);}
         _U.badCase($moduleName,
         "between lines 878 and 881");
      }();
   });
   var step = F2(function (input,
   state) {
      return $Debug.watch("Step")(doBackground(doUpdates(doActions(doCollisions(progress(A2(setInput,
      state,
      input)))))));
   });
   var playerHealth = 10;
   var initState = {_: {}
                   ...
                   ,badAgents: _L.fromArray([])
                   ,badBullets: _L.fromArray([])
                   ,deltas: 0.0
                   ,events: events
                   ,goodBullets: _L.fromArray([])
                   ,player: A3(player,
                   playerWeapons,
                   playerHealth,
                   {ctor: "_Tuple2"
   ...
   _elm.Main.values = {_op: _op
                      ...
                      ,playerWeapons: playerWeapons
                      ,coolDownPlayerWeapons: coolDownPlayerWeapons
                      ,firePlayerWeapons: firePlayerWeapons
                      ,updatePlayerWeapons: updatePlayerWeapons
                      ,State: State
                      ,vectorAdd: vectorAdd
                      ,vectorDiff: vectorDiff
                      ,vectorPolar: vectorPolar
                      ,angle: angle
                      ,vectorAddPolar: vectorAddPolar
                      ...
                      ,killIfOffScreen: killIfOffScreen
                      ,actionOnPress: actionOnPress
                      ,shootBulletFanHelper: shootBulletFanHelper
                      ,shootBulletFan: shootBulletFan
                      ,shootGoodBulletFan: shootGoodBulletFan
                      ,within: within
                      ,seeker: seeker
                      ,closestEnemyFold: closestEnemyFold
                      ,closestEnemyPosition: closestEnemyPosition
                      ,goodSeeker: goodSeeker
                      ,goodLaser: goodLaser
                      ,missile: missile
                      ,mine: mine
                      ,stabber: stabber
                      ,bulletChaser: bulletChaser
                      ,chaser: chaser
                      ,moveStrait: moveStrait
                      ,moveTurning: moveTurning
                      ,orbiter: orbiter
                      ,stabberCarrier: stabberCarrier
                      ,bulletChaserCarrier: bulletChaserCarrier
                      ,carrier: carrier
                      ,bulletExplosion: bulletExplosion
                      ,goodBulletExplosion: goodBulletExplosion
                      ,exploder: exploder
